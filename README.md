...
- 🧰 Pro skill: React.js · Next.js · Typescript · Node.js · Express.js · PHP · Laravel · MySQL · NoSQL · AWS(EC2, S3, Lambda, DynamoDB etc.) · Firebase · HTML, CSS, Bootstrap · Tailwind · jQuery · Android · API development & Integration
