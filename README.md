...
- 🧰 Pro skill: React.js · Next.js · Typescript · Node.js · Express.js · PHP · Laravel · MySQL · NoSQL(e.g. managed MongoAtlas, DynamoDB) · AWS(Ec2, S3, Lambda) · Firebase · HTML, CSS, Bootstrap · Tailwind · jQuery · Android · API development & Integration
